...
def call_llm(api_key: str, prompt: str, api_url: str, model: str) -> dict:
    # Support a bare base (https://api.openai.com), a versioned base
    # (https://api.openai.com/v1), and a full endpoint
    # (https://api.openai.com/v1/chat/completions) — append only the missing suffix.
    base = api_url.rstrip("/")
